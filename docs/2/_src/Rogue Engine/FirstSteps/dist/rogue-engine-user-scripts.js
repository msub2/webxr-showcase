...
const _Controller = class extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    super(...arguments);
    this.axes = new Float32Array(4);
    this.moveVector = new three__WEBPACK_IMPORTED_MODULE_1__.Vector3();
    this.headRot = new three__WEBPACK_IMPORTED_MODULE_1__.Euler();
  }
  get handOptions() {
    return ["Left", "Right"];
  }
  awake() {
    _Controller.sources.push(this);
  ...
  update() {
    ...
    rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Runtime.camera.updateWorldMatrix(true, true);
  }
  ...
  move() {
    const x = this.axes[2];
    const z = this.axes[3];
    const { camera } = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Runtime;
    this.moveVector.set(x, 0, z).normalize();
    this.headRot.setFromQuaternion(camera.quaternion);
    if (!this.fly)
      this.headRot.set(0, this.headRot.y, 0);
...
Controller.sources = [];
__decorateClass([
  (0,rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Prop)("Select")
], Controller.prototype, "hand", 2);
__decorateClass([
  (0,rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Prop)("Object3D")
], Controller.prototype, "player", 2);
__decorateClass([
  (0,rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Prop)("Boolean")
], Controller.prototype, "fly", 2);
__decorateClass([
  (0,rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Prop)("Number")
], Controller.prototype, "speed", 2);

rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(Controller);
...
(() => {
/*!************************************!*\
  !*** ./Assets/EnterVRButton.re.ts ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EnterVRButton)
/* harmony export */ });
/* harmony import */ var rogue_engine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rogue-engine */ "rogue-engine");
/* harmony import */ var rogue_engine__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(rogue_engine__WEBPACK_IMPORTED_MODULE_0__);
...
class EnterVRButton extends rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Component {
  awake() {
    const { renderer } = rogue_engine__WEBPACK_IMPORTED_MODULE_0__.Runtime;
    renderer.xr.enabled = true;
    const button = three_examples_jsm_webxr_VRButton__WEBPACK_IMPORTED_MODULE_1__.VRButton.createButton(renderer);
    document.body.appendChild(button);
  }
}
__name(EnterVRButton, "EnterVRButton");
rogue_engine__WEBPACK_IMPORTED_MODULE_0__.registerComponent(EnterVRButton);
